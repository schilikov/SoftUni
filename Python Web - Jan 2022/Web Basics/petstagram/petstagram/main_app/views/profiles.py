...
def create_profile(request):
    return profile_action(request, CreateProfileForm, 'home', Profile(), 'profile_create.html')
...
def delete_profile(request):
    return profile_action(request, DeleteProfileForm, 'home', get_profile(), 'profile_delete.html')
